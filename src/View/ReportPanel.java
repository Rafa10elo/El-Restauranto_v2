...
public class ReportPanel extends JPanel {
    public ReportPanel (Model.Report report,int numberOfUsers,int numberOfMeals){
        ...
        titlePanel.setBackground(MainFrame.lightBackground);
        ...
        titlePanel.setBorder(BorderFactory.createMatteBorder(0, 0, 3, 0, MainFrame.mainColor));
        ...
        sidePanel.setBackground(MainFrame.lightBackground);
        sidePanel.setPreferredSize(new Dimension(250, getHeight()));
        sidePanel.setBorder(BorderFactory.createMatteBorder(0, 0, 0, 3, MainFrame.mainColor));
        ...
        top3Meals.setForeground(MainFrame.mainColor);
        gbc.gridx = 0;
        gbc.gridy = 0;
        ...
        mainReportPanel.setBackground(MainFrame.darkBackground);
        ...
        if(String.valueOf(report.getTotalMoney())!=null) {
            ...
            totalIncome.setBorder(BorderFactory.createMatteBorder(1, 0, 1, 0, MainFrame.mainColor));
            gbc.gridx = 0;
            gbc.gridy = 5;
    ...
    JPanel createInfoPanel(String message1, String message2, Font fontBold, Font fontRegular){
        ...
        infoPanel.setBorder(BorderFactory.createMatteBorder(1,0,1,0,MainFrame.lightBackground));
    ...
    JPanel createMealPanel (Model.Meal meal){
        ...
        mealPanel.setBorder(BorderFactory.createMatteBorder(1, 1, 1, 1,MainFrame.lightBackground));
